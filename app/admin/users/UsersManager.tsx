                                        ...
                                        <td className="px-5 py-3.5 text-right">
                                            <div className="relative inline-block">
                                                <button
                                                    ...
                                                    className="cursor-pointer rounded-lg border border-gray-200 p-1.5 text-gray-500 transition hover:bg-gray-50"
                                                ...
                                                {openMenuId === user.id && (
                                                    <div
                                                        className="absolute right-0 top-8 z-20 min-w-[130px] overflow-hidden rounded-xl border border-gray-100 bg-white shadow-lg"
                                                        onClick={(e) => e.stopPropagation()}
                                                    >
                                                        <button
                                                            onClick={() => { setEditTarget(user); setOpenMenuId(null); }}
                                                            className="flex w-full cursor-pointer items-center gap-2 px-4 py-2.5 text-sm text-gray-700 transition hover:bg-gray-50"
                                                        >
                                                        ...
                                                        <button
                                                            ...
                                                            className="flex w-full cursor-pointer items-center gap-2 px-4 py-2.5 text-sm text-red-500 transition hover:bg-red-50"
                                                        >
